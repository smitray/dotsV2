...
source: sitemap
fetched_at: 2026-02-01T09:23:18.649480564-03:00
rendered_js: false
word_count: 632
summary: This document provides guidance on properly setting environment variables for Hyprland and related components, focusing on best practices for uwsm users and explaining various environment variables for theming, toolkits, and hardware-specific configurations.
tags:
    - hyprland
...
## Aquamarine Environment Variables[](#aquamarine-environment-variables)
...
If your [desktop portal](https://wiki.archlinux.org/title/XDG_Desktop_Portal) is malfunctioning for seemingly no reason (no errors), it’s likely your XDG env isn’t set correctly.
...
- `XCURSOR_SIZE` - Set cursor size. See [here](https://wiki.hypr.land/FAQ/) for why you might want this variable set.